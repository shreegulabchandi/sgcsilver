    ...
    for (const product of products) {
      for (const variant of product.variants) {
        ...
        if (weightG === null) {
          ...
          updated++;
          log(`   📦 ${product.title} [${variant.title}] | weight: ${weightG}g | (₹${silverPrice.toFixed(2)}+50) × ${weightG} × 1.03 = ₹${newPrice}`);
        }
